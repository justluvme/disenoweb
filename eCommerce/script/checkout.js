document.addEventListener("DOMContentLoaded", () => {
    ...
    (function () {
        emailjs.init("c7-_oSYNLlPhVaB4H"); // Reemplaza con tu clave pública
    })();
    
    function sendEmail(event) {
        event.preventDefault();
        emailjs.sendForm('service_603zm2g', 'template_8h8s0w6', event.target) // Reemplazar con ID servicio/template
